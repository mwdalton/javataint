...
{
    private static final String LOG_BASE = "com.siegebrk";
    private static final Logger defaultLogger   = Logger.getLogger(LOG_BASE);

    public static void doLog(String logSuffix, String type, SiegeBrkException e)
    {
        if (e.isWhitelisted())
            return;
    ...
    public static void attack(String type, SiegeBrkException e)
    {
        doLog(type + ".attack", type + " Attack", e);
    }
    
    public static void vuln(String type, SiegeBrkException e) {
