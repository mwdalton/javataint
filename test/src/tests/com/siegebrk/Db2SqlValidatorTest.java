...
public class Db2SqlValidatorTest
{

    private final int maxlen;
    private final SafeRandom sr;
    private final boolean blockComments;
    private final Db2SqlValidator v;
    private boolean exception;

    public Db2SqlValidatorTest(int maxlen, SafeRandom sr,
                               boolean blockComments)
    {
        this.maxlen = maxlen;
        this.sr = sr;
        this.blockComments = blockComments;
        this.v = new Db2SqlValidator(blockComments);
        clearException();
    }
    ...
    public static void main(String[] args) {
        ...
        SafeRandom sr;
        Db2SqlValidatorTest qt;
        String logfile = "Db2SqlValidatorTest.log";
        PrintStream ps = null;
        ...
        for (int i = 0; i < args.length; i++) {
           if (args[i].equals("-s"))
               ...
               System.out.println("Usage: java Db2SqlValidatorTest "
                       + "[-s randomSeed] "
        ...
        qt = new Db2SqlValidatorTest(maxlen, sr, sr.nextBoolean());
