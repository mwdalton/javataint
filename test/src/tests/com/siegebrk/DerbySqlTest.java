...
public class DerbySqlTest
{
    ...
    private final DerbySqlValidatorTest ds;

    private final List connections,
                       statements,
                       rowsets;

    public DerbySqlTest(int maxlen, SafeRandom sr) {
        this.maxlen = maxlen;
        this.sr = sr;
        ...
        dmd = new MockDatabaseMetaData("Apache Derby", dbMaj, dbMin);
        ds = new DerbySqlValidatorTest(maxlen, sr, dbMin >= 4);
    }
    ...
    public static void main(String[] args) {
        ...
        DerbySqlTest dt;
        String logfile = "DerbySqlTest.log";
        PrintStream ps = null;
        ...
        for (int i = 0; i < args.length; i++) {
           if (args[i].equals("-s"))
               ...
               System.out.println("Usage: java DerbySqlTest "
                       + "[-s randomSeed] "
        ...
        dt = new DerbySqlTest(maxlen, new SafeRandom(seed));
